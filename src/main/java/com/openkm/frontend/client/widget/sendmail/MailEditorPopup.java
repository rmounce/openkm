...
import com.openkm.frontend.client.widget.base.ExtendedDialogBoxWithBackgroundGrayEffect;
 ...
 * @author sochoa
 */
public class MailEditorPopup extends ExtendedDialogBoxWithBackgroundGrayEffect implements CaptionHandler {
	...
	private void initComponents() {
		toRecipientMap = new HashMap<String, Widget>();
		bccRecipientMap = new HashMap<String, Widget>();
		ccRecipientMap = new HashMap<String, Widget>();
		replyToRecientMap = new HashMap<String, Widget>();
		attachmentMap = new HashMap<String, Widget>();
	...
	public void jsSendMail(String htmlText) {
		...
		if (toUsers.size() == 0 && toRoles.size() == 0 && toMails.size() == 0 &&
			...
			final Map<String, List<String>> recipientsMap = new HashMap<String, List<String>>();
	...
	public void addRecipients(String recipients, FlowPanel fPanel, ScrollPanel scrollPanel, Map<String, Widget> recipientMap, List<String> recipientList) {
		...
		List<String> recipientNames = new ArrayList<String>(Arrays.asList(recipients.isEmpty() ? new String[0] : recipients.replaceAll(" ", "").split(",")));
	...
	public void drawMailEditor() {
		...
		toRoles = new ArrayList<String>();
		toMails = new ArrayList<String>();
		ccUsers = new ArrayList<String>();
		ccRoles = new ArrayList<String>();
		ccMails = new ArrayList<String>();
		bccUsers = new ArrayList<String>();
		bccRoles = new ArrayList<String>();
		bccMails = new ArrayList<String>();
		replyToUsers = new ArrayList<String>();
		replyToRoles = new ArrayList<String>();
		replyToMails = new ArrayList<String>();
