 ...
 * @author sochoa
 */
public class RecipientsPopup extends ExtendedDialogBoxWithBackgroundGrayEffect implements NotifyHandler {
	...
	public RecipientsPopup() {
		...
		acceptButton = new Button(Main.i18n("button.accept"), new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				Map<String, Widget> recipientMap = new HashMap<String, Widget>();
	...
	public void evaluateSendButton() {
		boolean enabled = (!notifyPanel.getUsersToNotify().equals("") || !notifyPanel.getRolesToNotify().equals("") || !notifyPanel.getExternalMailAddress().equals(""));
